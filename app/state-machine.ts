...
const ALLOWED_TRANSITIONS: Record<AgentState, AgentState[]> = {
  ...
  UNDERSTANDING: ["PLANNING", "EXECUTING", "WAITING", "FAILED", "IDLE"],
  PLANNING: ["EXECUTING", "VERIFYING", "WAITING", "COMPLETED", "FAILED", "IDLE"],
  EXECUTING: ["VERIFYING", "PLANNING", "WAITING", "COMPLETED", "FAILED"],
  VERIFYING: ["PLANNING", "EXECUTING", "COMPLETED", "FAILED", "IDLE"],
